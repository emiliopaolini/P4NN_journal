...
def nn(bitwidth, LUT,class_number):
    ...
    if LUT == 1:
        ...
        model1_out_2 = Dense(class_number, activation='sigmoid', name='output_layer_1_2')(bn2)
    ...
    if LUT == 5:
        ...
        model7_out_2 = Dense(class_number, activation='sigmoid', name='output_layer_7_2')(bn1)
