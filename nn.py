...
def nn(bitwidth, LUT,class_number):
    ...
    if LUT == 8:
        ...
        model1_out_2 = Dense(32, activation='relu', name='layer_1_12')(bn_1_1)
        bn_1_12 = BatchNormalization()(model1_out_2)
        model1_out_11 = Dense(16, activation='relu', name='layer_1_11')(bn_1_12)
        ...
        model2_out_12 = Dense(32, activation='relu', name='layer_2_21')(bn_2_1)
        bn_2_12 = BatchNormalization()(model2_out_12)
        model2_out_11 = Dense(16, activation='relu', name='layer_2_11')(bn_2_12)
        ...
        model3_out_12 = Dense(32, activation='relu', name='layer_3_12')(bn_3_1)
        bn_3_12 = BatchNormalization()(model3_out_12)


        model3_out_11 = Dense(16, activation='relu', name='layer_3_11')(bn_3_12)
        ...
        model4_out_12 = Dense(32, activation='relu', name='layer_4_12')(bn_4_1)
        bn_4_12 = BatchNormalization()(model4_out_12)

        model4_out_11 = Dense(16, activation='relu', name='layer_4_11')(bn_4_12)
        ...
        #model4_out_1 = lq.layers.QuantDense(256, activation='relu', name='layer_4_1', **kwargs)(concatenated_4)
        new_model4_out_1 = Dense(64, activation='relu', name='new_layer_5_1')(new_concatenated_4)
        new_bn_4_1 = BatchNormalization()(new_model4_out_1)

        model5_out_12 = Dense(32, activation='relu', name='layer_5_12')(new_bn_4_1)
        bn_5_12 = BatchNormalization()(model5_out_12)


        new_model4_out_11 = Dense(16, activation='relu', name='new_layer_4_11')(bn_5_12)
        ...
        model6_out_12 = Dense(32, activation='relu', name='layer_6_12')(bn_5_1)
        bn_6_12 = BatchNormalization()(model6_out_12)



        model5_out_11 = Dense(16, activation='relu', name='layer_5_11')(bn_6_12)
        ...
        model7_out_12 = Dense(32, activation='relu', name='layer_7_12')(bn_6_1)
        bn_7_12 = BatchNormalization()(model7_out_12)

        model6_out_11 = Dense(16, activation='relu', name='layer_6_11')(bn_7_12)
        ...
        model7_out_3 = Dense(64, activation='relu', name='output_layer_7_3')(concatenated_7)
        bn_7_1 = BatchNormalization()(model7_out_3)

        
        model8_out_12 = Dense(32, activation='relu', name='layer_8_12')(bn_7_1)
        bn_8_12 = BatchNormalization()(model8_out_12)


        model7_out_4 = Dense(16, activation='relu', name='output_layer_7_4')(bn_8_12)
        ...
        new_model7_out_3 = Dense(64, activation='relu', name='new_output_layer_7_3')(new_concatenated_7)
