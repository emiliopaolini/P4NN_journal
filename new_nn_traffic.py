...
def nn(bitwidth, LUT,class_number):
    ...
    if LUT == 1:
        ...
        model1_layer_1 = Dense(256, activation='relu', name='model1_layer_1')(model_1_concatenated)
    ...
    if LUT == 5:
        ...
        model2_layer_1 = Dense(256, activation='relu', name='model2_layer_1')(model_2_concatenated)
        ...
        model3_layer_1 = Dense(256, activation='relu', name='model3_layer_1')(model_3_concatenated)
        ...
        model5_layer_1 = Dense(256, activation='relu', name='model5_layer_1')(model_5_concatenated)
        ...
        model7_in_1_quant = lq.quantizers.DoReFa(k_bit=bitwidth, mode="activations",name='model7_in_1_quant')(model3.output)
        ...
        model7_layer_1 = Dense(256, activation='relu', name='model7_layer_1')(model_7_concatenated)
    ...
    if LUT == 7:
        ...
        model1_layer_1 = Dense(128, activation='relu', name='model1_layer_1')(model_1_concatenated)
        model1_bn_1 = BatchNormalization()(model1_layer_1)
        
        
        model1_layer_2 = Dense(64, activation='relu', name='model1_layer_2')(model1_bn_1)
        model1_bn_2 = BatchNormalization()(model1_layer_2)
        ...
        model2_layer_1 = Dense(128, activation='relu', name='model2_layer_1')(model_2_concatenated)
        model2_bn_1 = BatchNormalization()(model2_layer_1)

        
        model2_layer_2 = Dense(64, activation='relu', name='model2_layer_2')(model2_bn_1)
        model2_bn_2 = BatchNormalization()(model2_layer_2)
        ...
        model3_layer_1 = Dense(128, activation='relu', name='model3_layer_1')(model_3_concatenated)
        model3_bn_1 = BatchNormalization()(model3_layer_1)

        model3_layer_2 = Dense(64, activation='relu', name='model3_layer_2')(model3_bn_1)
        model3_bn_2 = BatchNormalization()(model3_layer_2)
        ...
        model4_layer_1 = Dense(128, activation='relu', name='model4_layer_1')(model_4_concatenated)
        model4_bn_1 = BatchNormalization()(model4_layer_1)

        model4_layer_2 = Dense(64, activation='relu', name='model4_layer_2')(model4_bn_1)
        ...
        model5_layer_1 = Dense(128, activation='relu', name='model5_layer_1')(model_5_concatenated)
        model5_bn_1  = BatchNormalization()(model5_layer_1)
        
        model5_layer_2 = Dense(64, activation='relu', name='model5_layer_2')(model5_bn_1)
        model5_bn_2 = BatchNormalization()(model5_layer_2)
        ...
        model6_layer_1 = Dense(128, activation='relu', name='model6_layer_1')(model_6_concatenated)
        model6_bn_1  = BatchNormalization()(model6_layer_1)

        
        model6_layer_2 = Dense(64, activation='relu', name='model6_layer_2')(model6_bn_1)
        ...
        model7_layer_1 = Dense(128, activation='relu', name='model7_layer_1')(model_7_concatenated)
        model7_bn_1  = BatchNormalization()(model7_layer_1)


        model7_layer_2 = Dense(64, activation='relu', name='model7_layer_2')(model7_bn_1)
        model7_bn_2 = BatchNormalization()(model7_layer_2)
