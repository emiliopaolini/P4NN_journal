...
def nn(bitwidth, LUT,class_number):
    ...
    if LUT == 1:
        ...
        model1_layer_2 = Dense(second_layer_neurons, activation='relu', name='model1_layer_2')(model1_bn_1)
        model1_dropout_2 = Dropout(0.05)(model1_layer_2)
        model1_bn_2 = BatchNormalization()(model1_dropout_2)
        
        model1_layer_3 = Dense(third_layer_neurons, activation='relu', name='model1_layer_3')(model1_bn_2)
        model1_dropout_3 = Dropout(0.05)(model1_layer_3)
        model1_bn_3 = BatchNormalization()(model1_dropout_3)
    ...
    if LUT == 5:
        ...
        model2_layer_2 = Dense(second_layer_neurons, activation='relu', name='model2_layer_2')(model2_bn_1)
        model2_bn_2 = BatchNormalization()(model2_layer_2)
        
        model2_layer_3 = Dense(third_layer_neurons, activation='relu', name='model2_layer_3')(model2_bn_2)
        ...
        model3_layer_2 = Dense(second_layer_neurons, activation='relu', name='model3_layer_2')(model3_bn_1)
        model3_bn_2 = BatchNormalization()(model3_layer_2)
        
        model3_layer_3 = Dense(third_layer_neurons, activation='relu', name='model3_layer_3')(model3_bn_2)
        ...
        model5_layer_2 = Dense(second_layer_neurons, activation='relu', name='model5_layer_2')(model5_bn_1)
        model5_bn_2 = BatchNormalization()(model5_layer_2)
        
        model5_layer_3 = Dense(third_layer_neurons, activation='relu', name='model5_layer_3')(model5_bn_2)
        ...
        model7_layer_2 = Dense(second_layer_neurons, activation='relu', name='model7_layer_2')(model7_bn_1)
        model7_bn_2 = BatchNormalization()(model7_layer_2)
        
        
        model7_layer_3 = Dense(third_layer_neurons, activation='relu', name='model7_layer_3')(model7_bn_2)
