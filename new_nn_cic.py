...
def nn(bitwidth, LUT,class_number):
    ...
    if LUT == 7:
        ...
        model4_layer_1 = Dense(256, activation='relu', name='model4_layer_1')(model_4_concatenated)
        ...
        model6_layer_1 = Dense(256, activation='relu', name='model6_layer_1')(model_6_concatenated)
